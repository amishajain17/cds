...
if( !( $selectRes = mysqli_query($link,"SELECT * FROM `products` WHERE cat_id= $id")) ){
  ...
  <div class="container1 portfolio">
      ...
      if( mysqli_num_rows($selectRes )==0 ){
        ...
        while( $row = mysqli_fetch_assoc($selectRes) ){
          ?>
        <li class="col s12 m3">
          <div class="product_img"><a href="#!"><img src=<?php echo $row['image_link']; ?> /></a></div>
          <div class="product_text center"><p><?php echo $row['prod_name'] ; ?></p></div>
          <div class="product_text center"><p><?php echo $row['prod_price']."(".$row['discount'].")" ; ?></p></div>
          <!-- <div class="product_text center"><p><?php //echo $row['prod_description'] ; ?></p></div> -->
          <!-- <div class="product_text center"><p><?php //echo "Rating".$row['prod_rating'] ; ?></p></div> -->
